...
You have to design & build the backend for the application and the ability for the users to register, add tasks, manage tasks etc.
...
https://github.com/azaylamba/ticktick 
